...
public class TermInfosReaderIndexSmall extends TermInfosReaderIndex {
	...
	public static interface InstantOn {
		void save(TermInfosReaderIndexSmall small, Directory directory, String segment);
		boolean load(TermInfosReaderIndexSmall small, Directory directory, String segment);
	}
	
	public static InstantOn instantOn = new InstantOn() {
		@Override
		public void save(TermInfosReaderIndexSmall small, Directory directory, String segment) {

		}

		@Override
		public boolean load(TermInfosReaderIndexSmall small, Directory directory, String segment) {
			return false;
		}
	};
	...
	public TermInfosReaderIndexSmall(Directory directory, String segment) {
